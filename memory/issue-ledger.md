...
| #9 | Phase 1: admin console read-only operations surfaces | Medium | 8 | ready | No | failed | localhost | 2026-03-26T08-12-14-898Z-29873ca7 | codex/issue-9-phase-1-admin-console-read-only-operations-surfaces | TBD | Inspect local job |
