...
| #8 | Phase 0: admin control plane foundation and read-only overview slice | High | #5 | in_progress | No | branch `codex/issue-8-phase0-slice-a` | Execute PR Slice A in isolated worktree |
