...
- Review: mandatory local PR review before merge
...
- Each pull request must complete a recorded local PR review before merge.
- Local review findings must be resolved, accepted, or dismissed with a reason before merge.
