...
推荐直接使用 [project-bootstrap-prompt.md](prompts/project-bootstrap-prompt.md)。
...
- 运行 `scripts/init-project.ps1` / `scripts/init-project.sh`
- 运行 `scripts/check-governance.ps1` / `scripts/check-governance.sh`
- 只把高风险不确定项留在最小待确认清单里
