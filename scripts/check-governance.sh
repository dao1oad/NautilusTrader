...
remote_execution_path="ops/remote-execution.yaml"
[[ $(get_config_boolean "$remote_execution_path" "enabled") == "true" ]] || fail "remote-execution.yaml must enable local execution."
